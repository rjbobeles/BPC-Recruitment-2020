...
@Component
export default class SideQuest extends Vue {
  @Prop({ default: null, type: Object }) readonly content!: object

  @Prop({ default: null, type: Object }) readonly animation!: object
}
</script>
